...
public final class OwnerCallDialogBinder {
    ...
    public interface OwnerCallDialogActions {
        ...
        void onCallDismissed(@NonNull UnansweredOwnerCall call);
    }
    ...
    public static OwnerCallDialogPaging bind(@NonNull View root,
                                             @NonNull List<UnansweredOwnerCall> calls,
                                             int requestedIndex,
                                             long nowMillis,
        ...
        UnansweredOwnerCall call = calls.get(paging.getIndex());
    ...
    private static void bindActions(@NonNull View root, @NonNull UnansweredOwnerCall call,
