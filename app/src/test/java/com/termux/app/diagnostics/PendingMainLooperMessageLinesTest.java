...
public class PendingMainLooperMessageLinesTest {
    ...
    private static DiagnosticsReport reportWithMainLooperQueue(DiagnosticsMainLooperQueue mainLooperQueue) {
        return new DiagnosticsReport("0.119.0", 119, 0L,
            ...
            new DiagnosticsMainThreadStalls(250L, 0L, 0L, "", java.util.Collections.emptyList()), mainLooperQueue, 0L, new DiagnosticsBackgroundCycle(0L, java.util.Collections.<BackgroundCycleInterval>emptyList()), DiagnosticsVersionChange.sameVersionAsThePreviousLaunch(), DiagnosticsShellExits.NONE, DiagnosticsPhantomProcessMonitor.UNMEASURED, DiagnosticsAppProcessPopulation.UNMEASURED);
    }
