...
public class PersistedSessionTest {
    ...
    public void exposesAllConstructorValues() {
        PersistedSession session = new PersistedSession(
            "handle-1", "/bin/login", new String[]{"--login", "-c", "make"}, true, "/home/user");
    ...
    public void retainsNullValues() {
        PersistedSession session = new PersistedSession(null, null, null, false, null);
    ...
    public void copiesArgumentsOnConstructionSoLaterMutationDoesNotLeak() {
        ...
        PersistedSession session = new PersistedSession(null, null, arguments, false, null);
    ...
    public void copiesArgumentsOnReadSoCallerCannotMutateInternalState() {
        PersistedSession session =
            new PersistedSession(null, null, new String[]{"-c", "echo hi"}, false, null);
    ...
    public void supportsEmptyArgumentArray() {
        PersistedSession session = new PersistedSession(null, null, new String[0], false, null);
