...
public class SessionNewActivityStateSerializerTest {
    ...
    @Test
    public void roundTripPreservesSessionNameBellAndSeenTimes() throws JSONException {
        List<SessionNewActivityState> states = Arrays.asList(
            new SessionNewActivityState("session-one", 1_000L, 2_000L),
            new SessionNewActivityState("session-two", 7_000L, null));
