...
public class AlwaysPresentSessionStartupPlannerTest {
    ...
    public void planStartupBuildsAutosshCommandWhenTemplateConfigured() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=3 -o TCPKeepAlive=yes 'myhost'"}, startup.getArguments());
    }
    ...
    public void planStartupShellQuotesSessionNameWithSingleQuote() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=3 -o TCPKeepAlive=yes 'a'\\''b'"}, startup.getArguments());
    }
    ...
    public void planStartupBuildsDistinctCommandForEachConfiguredName() {
        ...
        Assert.assertEquals(Arrays.asList("-c", "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=3 -o TCPKeepAlive=yes 'alpha'"), Arrays.asList(alpha.getArguments()));
        Assert.assertEquals(Arrays.asList("-c", "ssh -o ServerAliveInterval=30 -o ServerAliveCountMax=3 -o TCPKeepAlive=yes 'beta'"), Arrays.asList(beta.getArguments()));
    }
