...
public class AlwaysPresentSessionStartupPlannerTest {
    ...
    public void planStartupBuildsAutosshCommandWhenTemplateConfigured() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh -o ServerAliveInterval=60 -o ServerAliveCountMax=3 'myhost'"}, startup.getArguments());
    }
    ...
    public void planStartupShellQuotesSessionNameWithSingleQuote() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh -o ServerAliveInterval=60 -o ServerAliveCountMax=3 'a'\\''b'"}, startup.getArguments());
    }
    ...
    public void planStartupBuildsDistinctCommandForEachConfiguredName() {
        ...
        Assert.assertEquals(Arrays.asList("-c", "ssh -o ServerAliveInterval=60 -o ServerAliveCountMax=3 'alpha'"), Arrays.asList(alpha.getArguments()));
        Assert.assertEquals(Arrays.asList("-c", "ssh -o ServerAliveInterval=60 -o ServerAliveCountMax=3 'beta'"), Arrays.asList(beta.getArguments()));
    }
