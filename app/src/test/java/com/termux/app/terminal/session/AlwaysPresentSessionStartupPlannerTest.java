...
public class AlwaysPresentSessionStartupPlannerTest {
    ...
    public void planStartupBuildsAutosshCommandWhenTemplateConfigured() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh 'myhost'"}, startup.getArguments());
    }
    ...
    public void planStartupShellQuotesSessionNameWithSingleQuote() {
        ...
        Assert.assertArrayEquals(new String[]{"-c", "ssh 'a'\\''b'"}, startup.getArguments());
    }
    ...
    public void planStartupBuildsDistinctCommandForEachConfiguredName() {
        ...
        Assert.assertEquals(Arrays.asList("-c", "ssh 'alpha'"), Arrays.asList(alpha.getArguments()));
        Assert.assertEquals(Arrays.asList("-c", "ssh 'beta'"), Arrays.asList(beta.getArguments()));
    }
