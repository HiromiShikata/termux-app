...
public class OwnerCallFileUrlTest {
    ...
    @Test
    public void reusesTheOriginAndTheAccessTokenOfTheStoredSessionDefinitionUrl() {
        Assert.assertEquals("https://calls.example.test/call-to-user/umino/"
    ...
    public void addressesExactlyTheFileTheSharedPathRuleNames() {
        ...
        Assert.assertEquals("https://calls.example.test/"
    ...
    public void keepsThePortOfTheStoredSessionDefinitionUrl() {
        Assert.assertEquals("http://127.0.0.1:8080/call-to-user/NA/secretary.yaml?k=" + ACCESS_TOKEN,
