...
public abstract class TermuxSharedProperties {
    ...
    /**
     * Returns the int for the value if its not null and is between
     * {@link TermuxPropertyConstants#IVALUE_BACKGROUND_CALL_SCAN_INTERVAL_MINUTES_MIN} and
     * {@link TermuxPropertyConstants#IVALUE_BACKGROUND_CALL_SCAN_INTERVAL_MINUTES_MAX},
     * otherwise returns {@link TermuxPropertyConstants#DEFAULT_IVALUE_BACKGROUND_CALL_SCAN_INTERVAL_MINUTES}.
     *
     * @param value The {@link String} value to convert.
     * @return Returns the internal value for value.
     */
    public static int getBackgroundCallScanIntervalMinutesInternalPropertyValueFromValue(String value) {
        return SharedProperties.getDefaultIfNotInRange(TermuxPropertyConstants.KEY_BACKGROUND_CALL_SCAN_INTERVAL_MINUTES,
            DataUtils.getIntFromString(value, TermuxPropertyConstants.DEFAULT_IVALUE_BACKGROUND_CALL_SCAN_INTERVAL_MINUTES),
